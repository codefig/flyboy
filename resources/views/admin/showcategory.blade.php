                            ...
                            @if(count($categories) > 0 )
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.photocategory.edit', $category->id) }}" class="edit-link"><span class="fa fa-edit"></span></a>
                                            <a href="{{ route('admin.photocategory.delete', $category->id) }}" class="delete-link"><span class="fa fa-trash-o"></span></a>
                                        </td>
                                    </tr>
