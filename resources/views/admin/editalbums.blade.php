                ...
                <div class="col-lg-12">
                    ...
                    @if(count($album) > 0)
                        <div class="form-group" style="height:300px;width:300px;border-radius:5px;border:1px solid #ccc;">
                            <img class="img-responsive" src="{{ URL::to($album->image) }}">
                        </div>
                        <form method="post" action="{{ route('admin.musicalbum.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="major_link" name="major_link" value="{{$album->major_link}}">
                            </div>

                            <div class="form-group">
                                <label>Spotify Link</label>
                                <input type="text" class="form-control" id="spotify_link" name="spotify_link" value="{{$album->spotify_link}}">
                            </div>

                            <div class="form-group">
                                <label>Itunes Link</label>
                                <input type="text" class="form-control" id="itunes_link" name="itunes_link" value="{{$album->itunes_link}}">
                            </div>

                            <div class="form-group">
                                <label>SoundCloud Link</label>
                                <input type="text" class="form-control" id="soundcloud_link" name="soundcloud_link" value="{{$album->soundcloud_link}}">
                            </div>

                            <div class="form-group">
                                <input type="hidden" name="album_id" id="album_id" value="{{ $album->id }}">
                                <input type="submit" value="Update Album " class="btn btn-primary" name="addeventBtn" id="addeventBtn">
