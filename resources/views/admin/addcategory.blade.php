        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form method="post" action="{{route('admin.photocategory.submit')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" class="btn btn-primary" name="submitbtn" value="Add Category">
                        </div>
