                            ...
                            @if(count($photos) > 0 )
                                ...
                                @foreach($photos as $photo)
                                    <tr>
                                        ...
                                        <td><a href="{{ URL::to($photo->image) }}"><img style="height:200px;width:300px;" src="{{ URL::to($photo->image) }}" class="img-responsive img-rounded"></a></td>
                                        <td>{{ $photo->created_at->formatLocalized('%A, %d %B %Y.') }}</td>
                                        <td>
                                            <a href="{{ route('admin.photos.edit', $photo->id) }}" class="edit-link"><span class="fa fa-edit"></span></a>
                                            <a href="{{ route('admin.photos.delete', $photo->id) }}" class="delete-link"><span class="fa fa-trash-o"></span></a>
                                        </td>
                                    </tr>
