                            ...
                            @if(count($musics) > 0 )
                                ...
                                @foreach($musics as $music)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.musicalbum.edit', $music->id) }}" class="edit-link"><span class="fa fa-edit"></span></a>
                                            <a href="{{ route('admin.musicalbum.delete', $music->id) }}" class="delete-link"><span class="fa fa-trash-o"></span></a>
                                        </td>
                                    </tr>
