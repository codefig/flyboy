                            ...
                            @if(count($all_news) > 0 )
                                ...
                                @foreach($all_news as $news)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.news.edit', $news->id) }}" class="edit-link"><span class="fa fa-edit"></span></a>
                                            <a href="{{ route('admin.news.delete', $news->id) }}" class="delete-link"><span class="fa fa-trash-o"></span></a>
                                        </td>
                                    </tr>
