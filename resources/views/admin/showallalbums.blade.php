                            ...
                            @if(count($albums) > 0 )
                                ...
                                @foreach($albums as $album)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.musicalbum.edit', $album->id) }}" class="edit-link"><span class="fa fa-edit"></span></a>
                                            <a href="{{ route('admin.musicalbum.delete', $album->id) }}" class="delete-link"><span class="fa fa-trash-o"></span></a>
                                        </td>
                                    </tr>
