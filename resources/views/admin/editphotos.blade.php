                ...
                <div class="col-lg-12">
                    ...
                    @if(count($photo) > 0)
                        <div class="form-group" style="height:300px;width:300px;border-radius:5px;border:1px solid #ccc;">
                            <img class="img-responsive" src="{{ URL::to($photo->image) }}">
                        </div>
                        <form method="post" action="{{ route('admin.photos.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" value="Update Photo" class="btn btn-primary" name="addeventBtn" id="addeventBtn">
