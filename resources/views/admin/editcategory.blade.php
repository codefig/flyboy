                ...
                <div class="col-lg-12">
                    ...
                    @if(count($category) > 0)
                        <div class="form-group" style="height:300px;width:300px;border-radius:5px;border:1px solid #ccc;">
                            <img class="img-responsive" src="{{ URL::to($category->image) }}">
                        </div>
                        <form method="post" action="{{ route('admin.photocategory.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" value="Update Category" class="btn btn-primary" name="addeventBtn" id="addeventBtn">
