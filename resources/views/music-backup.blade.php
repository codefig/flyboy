...
@section('pageContent')
  ...
  <section id="music-player" style="font-family: 'Open Sans, Lato , sans-serif'">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-1">
          <img src="{{ URL::to('img/flyboy70.png') }}" alt="flyboy70">
        </div>
        <div class="col-md-4">
          <p>NEW RELEASE!!!</p>
          ...
          <br/>
          <p>
          <span class="fa fa-2x fa-soundcloud music-link"></span>
          &nbsp;
          <span class="fa fa-2x fa-spotify music-link"></span>
          &nbsp;
          <span class="fa fa-2x fa-spotify music-link"></span>

        </p>
          {{-- <p>Available on <span class='fa fa-2x fa-soundcloud'></span> iTunes, Cloudshot, <em>OptionTwo</em></p> --}}
        </div>
        <div class="col-md-1">
        </div>
        <div class="col-md-5">
          <img src="{{ URL::to('img/sy-loader.gif') }}" alt="discloader">
  ...
  <nav class="main-nav-outer" id="test">
    ...
    <div class="container">
      <ul class="main-nav">
        ...
        <li class="small-logo"><a href="#header"><img src="{{ URL::to('img/flyboy70.png') }}" alt="logo"></a></li>
